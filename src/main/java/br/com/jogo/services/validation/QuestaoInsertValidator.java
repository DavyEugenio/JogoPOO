...
public class QuestaoInsertValidator implements ConstraintValidator<QuestaoInsert, QuestaoNewDTO> {
	...
	@Override
	public boolean isValid(QuestaoNewDTO objDto, ConstraintValidatorContext context) {
